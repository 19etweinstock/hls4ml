...
set_top lenet5
add_files firmware/lenet5.cpp -cflags "-std=c++0x"
add_files -tb lenet5_test.cpp -cflags "-std=c++0x"
...
if {$opt(cosim)} {
  ...
  add_files -tb lenet5_test.cpp -cflags "-std=c++0x -DRTL_SIM"
  set time_start [clock clicks -milliseconds]
  cosim_design -trace_level all
  set time_end [clock clicks -milliseconds]
  puts "INFO:"
  puts [read [open lenet5_prj/solution1/sim/report/lenet5_cosim.rpt r]]
...
if {$opt(vsynth)} {
  ...
  if {[file exist lenet5_prj/solution1/syn/vhdl]} {
    set time_start [clock clicks -milliseconds]
